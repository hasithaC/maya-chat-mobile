...
interface SignUpOTPValidationScreenProps {
  identifier: string;
  identifierType: "mobile" | "email";
}

export function SignUpOTPValidationScreen({
  identifier,
  identifierType,
}: SignUpOTPValidationScreenProps) {
      ...
      <SafeAreaContainer>
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.heading}>to Continue to Your Account.</Text>
          </View>
            ...
            <View style={styles.content}>
              ...
              <View style={styles.footer}>
                <Text style={styles.footerText}>
                  By continuing you agree to Maya’s{" "}
